...
exports.isQuietHour = function() {
    ...
    return new Promise(async(res,rej) => {
        ...
        const until = moment(quietHours.end, "HH");

        console.log(` Start Time ${start}`);
        console.log(` End Time ${until}`);
        ...
        if(current_hour > start && current_hour < until) {
           console.log('Quite Hour : Yes');
            return true;
        } else {
            return false;
            console.log('Quite Hour : No');
        }
